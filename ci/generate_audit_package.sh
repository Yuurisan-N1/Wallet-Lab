...
#
# Usage:
#   bash ci/generate_audit_package.sh
#   bash ci/generate_audit_package.sh --build-dir build-audit
#   bash ci/generate_audit_package.sh --section math_invariants
#   bash ci/generate_audit_package.sh --skip-build
# ============================================================================
set -euo pipefail
...
if python3 "$PROJECT_ROOT/ci/collect_ct_evidence.py" \
